...
class DateUtil {
	...
	public static function incrementDate($date, $numDays){
		$oldDate = new DateTime($date." 12:00:00");
		$oldDate->modify("+".$numDays." day");
		return $oldDate->format(DateUtil::MYSQLDATE_FORMAT);
	}
	
	public static function decrementDate($date, $numDays){
		$oldDate = new DateTime($date." 12:00:00");
		$oldDate->modify("-".$numDays." day");
		return $oldDate->format(DateUtil::MYSQLDATE_FORMAT);
	}
